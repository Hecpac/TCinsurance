...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "El impacto varía por edad, código postal, plan y nivel de ingresos, pero los datos oficiales del mercado en Texas son contundentes:\n- **Aumento promedio: ~34%** en primas del mercado individual\n- **4.1 millones de texanos** estaban inscritos en planes ACA — el 95% recibía algún subsidio\n- Se estima que entre **665,000 y 1.45 millones de texanos** podrían perder cobertura por el aumento de costos",
